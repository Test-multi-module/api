...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> NICK_NAME = createField(DSL.name("nick_name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.users.day_of_birth</code>.
     */
    public final TableField<UsersRecord, LocalDateTime> DAY_OF_BIRTH = createField(DSL.name("day_of_birth"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>public.users.auth_user_id</code>.
     */
    public final TableField<UsersRecord, UUID> AUTH_USER_ID = createField(DSL.name("auth_user_id"), SQLDataType.UUID.nullable(false), this, "");
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USERS_AUTH_USER_ID_KEY);
    }
